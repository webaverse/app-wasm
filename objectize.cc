...
EMSCRIPTEN_KEEPALIVE bool getGeometryPhysics(PScene *scene, unsigned int id, float *positions, unsigned int *indices) {
  return scene->getGeometry(id, positions, indices);
}
