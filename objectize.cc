...
EMSCRIPTEN_KEEPALIVE void cookHeightFieldGeometryPhysics(uint8_t **data, unsigned int *length, PxDefaultMemoryOutputStream **writeStream) {
  physicsBase->cookHeightFieldGeometry(data, length, writeStream);
}
