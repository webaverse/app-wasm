...
EMSCRIPTEN_KEEPALIVE float* generateTerrain(float chunkSize, int chunkCount, int maxSegment) {
  return Terrain::generateTerrain(chunkSize, chunkCount, maxSegment);
}
