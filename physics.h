...
public:
  ...
  float *getPath(float *_start, float *_dest, float hx, float hy, float hz, float *position, float *quaternion, float *meshPosition, float *meshQuaternion, unsigned int maxIterDetect, unsigned int numIgnorePhysicsIds, unsigned int *ignorePhysicsIds);
