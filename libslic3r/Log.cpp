...
void _Log::error(const std::string& topic, const std::wstring& message) { }
void _Log::warn(const std::string& topic, const std::wstring& message) {  }
void _Log::info(const std::string& topic, const std::wstring& message) { }
void _Log::debug(const std::string& topic, const std::wstring& message) {  }
...
void _Log::raw(const std::wstring& message) { }
