...
public:
  // Hips = 0, // position
  int Hips = boneIota++; // quaternion
  int Spine = boneIota++;
  int Chest = boneIota++;
  int UpperChest = boneIota++;
  int Neck = boneIota++;
  int Head = boneIota++;
  int Left_shoulder = boneIota++;
  int Left_arm = boneIota++;
  int Left_elbow = boneIota++;
  int Left_wrist = boneIota++;
  int Left_middleFinger1 = boneIota++;
  int Left_middleFinger2 = boneIota++;
  int Left_middleFinger3 = boneIota++;
  int Left_thumb0 = boneIota++;
  int Left_thumb1 = boneIota++;
  int Left_thumb2 = boneIota++;
  int Left_indexFinger1 = boneIota++;
  int Left_indexFinger2 = boneIota++;
  int Left_indexFinger3 = boneIota++;
  int Left_ringFinger1 = boneIota++;
  int Left_ringFinger2 = boneIota++;
  int Left_ringFinger3 = boneIota++;
  int Left_littleFinger1 = boneIota++;
  int Left_littleFinger2 = boneIota++;
  int Left_littleFinger3 = boneIota++;
  int Right_shoulder = boneIota++;
  int Right_arm = boneIota++;
  int Right_elbow = boneIota++;
  int Right_wrist = boneIota++;
  int Right_middleFinger1 = boneIota++;
  int Right_middleFinger2 = boneIota++;
  int Right_middleFinger3 = boneIota++;
  int Right_thumb0 = boneIota++;
  int Right_thumb1 = boneIota++;
  int Right_thumb2 = boneIota++;
  int Right_indexFinger1 = boneIota++;
  int Right_indexFinger2 = boneIota++;
  int Right_indexFinger3 = boneIota++;
  int Right_ringFinger1 = boneIota++;
  int Right_ringFinger2 = boneIota++;
  int Right_ringFinger3 = boneIota++;
  int Right_littleFinger1 = boneIota++;
  int Right_littleFinger2 = boneIota++;
  int Right_littleFinger3 = boneIota++;
  int Right_leg = boneIota++;
  int Right_knee = boneIota++;
  int Right_ankle = boneIota++;
  int Right_toe = boneIota++;
  int Left_leg = boneIota++;
  int Left_knee = boneIota++;
  int Left_ankle = boneIota++;
  int Left_toe = boneIota++;
};
