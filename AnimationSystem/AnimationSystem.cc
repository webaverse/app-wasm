...
namespace AnimationSystem {
  ...
  Avatar *createAnimationAvatar(AnimationMixer *mixer) {
    ...
    avatar->actionInterpolants["activate"] = new UniActionInterpolant(0, 750); // todo: activateMaxTime = 750;
  ...
  void Avatar::addAction(char *scratchStack, unsigned int stringByteLength) {
    ...
    if (j["type"] == "jump") {
      ...
      // this->movementsActionsCount++;
      // std::cout << "movementsActionsCount: " << movementsActionsCount << std::endl;
    }
  }
  void Avatar::removeAction(char *scratchStack, unsigned int stringByteLength) {
    ...
    if (j["type"] == "jump") {
      ...
      // this->movementsActionsCount--;
      // if (this->movementsActionsCount == 0) {
